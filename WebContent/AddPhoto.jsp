...
<body>
    <div style="height: 500px;">
        <div class="img-box">
           ...
           <a class="shan" onclick="deleteImg();"><img src="img/shanD.jpg"></a>
        </div>
        <input type="file" name="file" style="display:none;" onchange="previewImg(this);" id="upload" accept="img/*"/>
    </div>
</body>
